...
使用方法(到openclash配置文件处更新订阅链接)
    ...
    https://api.wcc.best/sub?target=clash&new_name=true&url=订阅链接(URL编码)&config=https%3A%2F%2Fraw.githubusercontent.com%2Fpanybbib%2Fclash-sub%2Fmain%2FFull.ini
